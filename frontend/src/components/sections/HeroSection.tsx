    ...
    return (
        <section className="flex flex-col gap-6 justify-between py-5 px-3.5 md:flex-row md:items-end md:px-5 lg:px-16">
            ...
            <div className="flex flex-wrap gap-4">
                <button className="bg-secondary-container flex font-mono gap-2 items-center px-6 py-3 rounded-xl text-secondary transition-all hover:bg-opacity-90 active:scale-95">
                    <span><MdPersonAddAlt /></span>Agregar Cliente
                </button>
                <button className="bg-primary flex font-mono gap-2 items-center px-6 py-3 rounded-xl shadow-sm text-on-surface transition-all hover:bg-opacity-90 active:scale-95">
