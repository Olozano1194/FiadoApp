                ...
                return (
                    ...
                    >
                        ...
                        <picture className='aspect-square bg-surface-container overflow-hidden rounded-lg w-full'>
                            {product.image ? (
                                <img src={product.image} alt={product.name} className='h-full object-cover transition-transform w-full group-hover:scale-105' />
                            ) : (
                                <div className='w-full h-full flex items-center justify-center bg-linear-to-br from-primary/10 to-secondary/10'>
                                    <svg className="w-12 h-12 text-on-surface-variant/40" fill="none" viewBox="0 0 24 24" stroke="currentColor">
